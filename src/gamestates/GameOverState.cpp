...
GameOverState::GameOverState(GameContext* context) : ds::BasicMenuGameState("GameOver", "GameOverDialog"), _context(context) {
}
...
void GameOverState::activate() {
	...
	std::string str;
	ds::GUIDialog* hud = ds::res::getGUIDialog("HUD");

	ds::GameTimer* timer = hud->getTimer(3);
